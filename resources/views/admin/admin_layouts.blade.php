...
@else
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> E3mel Business</a></div>
    <div class="sl-sideleft">
        <div class="sl-sideleft-menu">
            ...
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="{{route('courses')}}" class="nav-link">All Course</a></li>
            </ul>
                ...
                <div class="dropdown">
                    <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                        <span class="logged-name"><span
                                class="hidden-md-down"> {{\Illuminate\Support\Facades\Auth::user()->name}}</span></span>
